...
export class Meteor extends Phaser.Scene {
    ...
    editorCreate() {
        ...
        // livello_tile_1
        const livello_tile_1 = ground.createLayer(
            "Livello tile 1",
            ["Ground", "Fantascienza"],
            -98,
            201
    ...
    dates = [
        "30 June 1908, Tunguska River, Russia",
        "9 April 1941, Chelyabinsk, USSR",
        "12 February 1947, Sikhote-Alin Mountains, USSR",
        "25 September 2002, Bodaybo, Russia",
        "7 February 2009, Tyumen Oblast, Russia",
        "15 February 2013, Chelyabinsk, Russia",
        "15 December 2017, Kamchatka, Russia",
        "18 December 2018, Kamchatka, Russia",
        "25 February 2020, Lake Baikal, Russia",
    ]
    ...
    showEndScreen(message, gameover) {
        ...
        setTimeout(() => {
            ...
            this.scene.start(Level.name, {
                gameOver: !!gameover,
                partialScore: gameover
                    ? this.explodedCount > 100
                        ? 100
                        : this.explodedCount
                    : 100,
            })
    ...
    create() {
        ...
        if (window.musicActive) this.meteorBgMusic.play()
        ...
        this.showMessage([
            ...
            "but do it before the meteor",
            "collides with the Earth!",
            "Every metorite falling on the structure",
            "will compromise it and decrease its charge",
            "",
            "- ARROWS / WASD to move",
            "- SPACE BAR to shoot",
            "- SHIFT to boost ",
    ...
    win() {
        this.showEndScreen([
            "You have been able to charge SCP-2000,",
            "humanity is saved!",
        ])
    }
    ...
    decreaseLife(player, enemy) {
        ...
        const life = +this.life.text.replace("%", "")
        this.progress_bar.scaleX = life * 23 * 0.01
        if (life > 0) this.life.text = life - 5 + "%"
    }
